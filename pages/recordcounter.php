                                ...
                                <tbody>
                                   <?php
                                       ...
                                       for ($i = 0; $i < $TotalReg; $i++) {
                                           ...
                                           echo "<td>" ;
                                    ?>
                                           <a href='../Prosses/exportuser.php?id=<?php echo $kuncinya;?>&profile=hapusbaris ' class='btn btn-danger' onClick="return confirm('HAPUS BARIS INI?')"><i class='fa fa fa-trash-o'></i></a>
