...
*/
   ...
   $mkbot->cmd('/start|/Start', function () {
      ...
      if (has($idtelegram) == false) {
         ...
         $text    = 'Selamat Datang di XPancur.NET';
         $options = [
            'parse_mode' => 'html'
         ];
   ...
   $mkbot->cmd('/deposit|/request', function ($jumlah) {
      ...
      if (!empty($jumlah)) {
         if (has($idtelegram) == false) {
            ...
            if (preg_match('/^[0-9]+$/', $jumlah)) {
               if (strlen($jumlah) < 7) {
                  ...
                  $text = 'Maaf Maksimal Deposit Top Up Rp. 200000';
               }
            } else {
         ...
         $text .= "Perintah ini di Gunakan untuk Request Deposit Saldo Kepada Administator \n";
   ...
   $mkbot->cmd('/daftar', function () {
      ...
      if (empty($nametelegram)) {
         ...
         if (has($idtelegram) == false) {
            ...
            if (empty($cek)) {
               $text .= "Mohon Maaf System Kami Mengalami Gangguan Silahkan Hubungi Administator Untuk Reservasi Layanan Ini\n";
            } else {
            ...
            if (has($id) == false) {
               ...
               if (preg_match('/^[0-9]+$/', $jumlahan)) {
                  if (strlen($jumlahan) < 7) {
                     ...
                     $text = 'Maaf Maksimal refund Rp. 200000';
                  }
               } else {
            ...
            if (has($id) == false) {
               ...
               if (preg_match('/^[0-9]+$/', $jumlah)) {
                  if (strlen($jumlah) < 7) {
                     ...
                     $text = 'Maaf Maksimal Top Up Rp. 200000';
                  }
               } else {
                  $text = 'Maaf input saldo hanya berupa angka saja';
               }
   ...
   $mkbot->cmd('!Menu|/Menu|/menu', function () {
      ...
      $text .= "<code>📑 ▬▬ι Daftar Harga Voucher ι▬▬ 📑</code>\n";
